...
export default function StudentNav({ user }: StudentNavProps) {
  ...
  const navItems = [
    { name: 'My Library', href: '/dashboard/student', icon: '📚' },
    { name: 'Reading Progress', href: '/dashboard/student/progress', icon: '📊' },
    { name: 'Achievements', href: '/dashboard/student/achievements', icon: '🏆' },
          ...
          <div className="p-6 border-b">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-gray-800 truncate">{user.name || 'Student'}</p>
