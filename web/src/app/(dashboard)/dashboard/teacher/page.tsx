...
export default async function TeacherDashboardPage() {
  ...
  const allTeachers = allTeachersData?.map(t => ({
    id: t.id,
    ...
    <div className="space-y-8">
      <section className={cardClass}>
        <div>
          ...
          <h2 className="text-2xl font-black text-indigo-950">Classroom Management</h2>
          <p className="text-sm text-indigo-500">Create classes and manage your students.</p>
        </div>
