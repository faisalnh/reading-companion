...
export const TextFlipReader = forwardRef<
  TextFlipReaderRef,
  TextFlipReaderProps
>(
  ...
  ({ textContent, initialPage = 1, onPageChange, bookTitle }, ref) => {
    ...
    const handleJumpSubmit = (e: React.FormEvent) => {
      ...
      if (
        !isNaN(pageNum) &&
        pageNum >= 1 &&
        pageNum <= textContent.totalPages
      ) {
    ...
    return (
      <div
        ...
        style={
          isFullscreen ? { backgroundColor: "var(--reader-bg)" } : undefined
        }
      >
        ...
        <div
          className={clsx(
            ...
            isFullscreen
              ...
              : "rounded-lg",
            isFullscreen ? "" : isMobile && isPortrait ? "p-2" : "p-4",
          )}
          style={
            isFullscreen
          ...
          <div className="rounded-2xl border-2 border-green-200 bg-gradient-to-r from-green-50 to-emerald-50 px-4 py-3">
            ...
            <div className="mt-2 h-2 w-full overflow-hidden rounded-full bg-indigo-100">
              <div
                ...
                style={{
                  width: `${(currentPage / textContent.totalPages) * 100}%`,
                }}
              ></div>
            </div>
          </div>
